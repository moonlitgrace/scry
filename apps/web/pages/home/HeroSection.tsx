...
export default function HeroSection() {
  return <>
    <div className="absolute top-20 md:top-10 inset-x-0 h-96 md:h-[50rem] bg-size-[auto_100rem] -z-1 mask-y-from-20% mask-y-to-90%" style={{ backgroundImage: 'url(/svg/grids.svg)' }}></div>
    <HomeSectionLayout>
      <h1 className="text-2xl md:text-6xl font-bold text-center leading-tight">Track <span className="text-muted">Hidden</span> <span className="text-destructive underline decoration-wavy">Errors</span> <br /> in your JS Apps.</h1>
